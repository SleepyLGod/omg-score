/**
 * ⭐ A test framework for JavaScript using Mocha.
 * Just run: `npm test` in your terminal.
 */
var assert = require('assert');
var sinon = require('sinon');

var TestMidiPlayer = require('..');
	...
	describe('#Player', function () {
		...
		describe('#getCurrentTick', function () {
			it('should return correct tick when skipping without playing.', function () {
				const skipTicks = 500;
				const Player = new TestMidiPlayer.Player();
				Player.loadDataUri(zelda);
				Player.skipToTick(skipTicks);
